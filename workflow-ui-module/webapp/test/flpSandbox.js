		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflownewworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflownewworkflowuimodule-display": {
								"semanticObject": "workflownewworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflownew.workflowuimodule",
									"url": sap.ui.require.toUrl("workflownew/workflowuimodule")
								}
							}
						}
					}
